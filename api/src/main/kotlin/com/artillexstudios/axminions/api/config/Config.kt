...
class Config(file: File, stream: InputStream) {
    companion object {
        ...
        @JvmStatic
        fun BLOCK_ISLAND_DISBAND_WITH_MINIONS() = AxMinionsAPI.INSTANCE.getConfig().get("block-island-disband-with-minions", true)
        @JvmStatic
        ...
        @JvmStatic
        fun PRICES_HOOK() = AxMinionsAPI.INSTANCE.getConfig().get("hooks.prices", "Essentials")
        @JvmStatic
