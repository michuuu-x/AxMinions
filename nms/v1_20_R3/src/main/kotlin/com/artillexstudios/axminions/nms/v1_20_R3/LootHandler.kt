...
object LootHandler {
    ...
    fun generateEntityLoot(minion: Minion, entity: org.bukkit.entity.Entity): List<ItemStack> {
        val nmsEntity = (entity as CraftEntity).handle as LivingEntity
        val lootTableKey = nmsEntity.lootTable ?: return emptyList()
        ...
        val lootParams = LootParams.Builder(level)
            ...
            .withOptionalParameter(LootContextParams.KILLER_ENTITY, dummy)
            .withOptionalParameter(LootContextParams.DIRECT_KILLER_ENTITY, dummy)
            .withOptionalParameter(LootContextParams.LAST_DAMAGE_PLAYER, (ownerPlayer as? CraftPlayer)?.handle)
            .create(LootContextParamSets.ENTITY)

        val lootTable = MinecraftServer.getServer().lootData.getLootTable(lootTableKey)
