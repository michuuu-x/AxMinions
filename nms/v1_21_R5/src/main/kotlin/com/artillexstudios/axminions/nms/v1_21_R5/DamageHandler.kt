package com.artillexstudios.axminions.nms.v1_21_R5
...
object DamageHandler {
    ...
    fun damage(source: Minion, entity: Entity) {
        ...
        synchronized(DUMMY_ENTITY) {
            ...
            val damageSource = nmsEntity.damageSources().mobAttack(DUMMY_ENTITY)
            ...
            if (f > 0.0f || f1 > 0.0f) {
                ...
                if (nmsEntity is LivingEntity && (nmsEntity.health - finalDamage) <= 0) {
                    ...
                    // 3. Usuwamy standardowy drop, żeby nie wypadł na ziemię
                    (entity as? org.bukkit.entity.Mob)?.lootTable = null
                }
                // --------------------------

                val flag5 = nmsEntity.hurtServer((source.getLocation().world as CraftWorld).handle as ServerLevel, damageSource, finalDamage)
